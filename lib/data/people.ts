...
export const HOSTS: Host[] = [
  { id: "h1", name: "Priya", avatar: "👩", joinedYear: 2019, responseRate: 98, isVerified: true,
  ...
  { id: "h2", name: "Tenzin", avatar: "🧔", joinedYear: 2021, responseRate: 92, isVerified: true,
  ...
  { id: "h3", name: "Mathew", avatar: "👨", joinedYear: 2017, responseRate: 100, isVerified: true,
    about: "Third generation on the backwaters. The boat is crewed by people I have known my whole life." },
  { id: "h4", name: "Sunita", avatar: "👵", joinedYear: 2020, responseRate: 95, isVerified: true,
  ...
  { id: "h5", name: "Arjun", avatar: "🧑", joinedYear: 2022, responseRate: 88, isVerified: false,
    about: "I look after two places, one on a coffee estate and one on a ridge. Both are quiet on purpose." },
  { id: "h6", name: "Claire", avatar: "👱", joinedYear: 2018, responseRate: 97, isVerified: true,
...
export const REVIEWS: Review[] = [
  { id: "r1", listingId: "1", author: "Nikhil", avatar: "🧑", date: "2026-09-04", rating: 5,
  ...
  { id: "r2", listingId: "1", author: "Farah", avatar: "👩", date: "2026-08-19", rating: 5,
