...
export const DESTINATIONS: Destination[] = [
  { slug: "goa",         name: "Goa",         emoji: "🏖️", listingCount: 1, tagline: "Beaches at both ends and a lot of quiet in between." },
  { slug: "manali",      name: "Manali",      emoji: "🏔️", listingCount: 1, tagline: "Cedar, snow, and roads that close without warning." },
  { slug: "kerala",      name: "Kerala",      emoji: "🛶", listingCount: 1, tagline: "Water instead of streets, for a few days at least." },
  { slug: "udaipur",     name: "Udaipur",     emoji: "🏰", listingCount: 1, tagline: "Lakes, ghats, and houses older than most countries." },
  { slug: "coorg",       name: "Coorg",       emoji: "🌿", listingCount: 1, tagline: "Coffee, rain, and nothing much to do on purpose." },
  { slug: "rishikesh",   name: "Rishikesh",   emoji: "🏞️", listingCount: 1, tagline: "The river is the reason. Everything else is nearby." },
  { slug: "pondicherry", name: "Pondicherry", emoji: "🌤️", listingCount: 1, tagline: "Shuttered windows and bakeries worth planning around." },
  { slug: "shillong",    name: "Shillong",    emoji: "🌲", listingCount: 1, tagline: "Pine ridges, low cloud, and very good live music." },
];
